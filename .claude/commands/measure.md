---
description: Fecha a Fase 4 de uma SPEC — registra custo, tokens, tempo e retro
argument-hint: SPEC-XXX
---

Feche a medição da SPEC `$ARGUMENTS`.
...
2. Grave em `metrics/$ARGUMENTS.json` no formato de
